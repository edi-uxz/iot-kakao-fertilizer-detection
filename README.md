# 🌿 AgroIntelli (AGRO_CORE v2.0)
> **Transformasi Digital Pertanian Presisi**  
> *Sistem Informasi Berbasis IoT dan AI untuk Deteksi Kebutuhan Pemupukan Tanaman Kakao Berdasarkan Kondisi Lingkungan.*

---

## 📌 Deskripsi Proyek

**AgroIntelli** adalah platform smart farming berbasis web yang memadukan teknologi **Internet of Things (IoT)** dan **Artificial Intelligence (AI)**. Sistem ini dirancang untuk membantu petani kakao dalam memantau kesehatan tanah secara *real-time* serta memberikan rekomendasi dosis dan waktu pemupukan yang akurat secara otomatis.
